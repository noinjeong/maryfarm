...
//                Toast.makeText(getActivity(), R.string.today, Toast.LENGTH_SHORT).show();
//            }
//        });
//
//        widget.setOnDateLongClickListener(getActivity());
//    }
    ...
    void onTextAppearanceChecked(boolean checked) {
        if (checked) {
            widget.setHeaderTextAppearance(com.prolificinteractive.materialcalendarview.R.style.TextAppearance_AppCompat_Large);
            widget.setDateTextAppearance(com.prolificinteractive.materialcalendarview.R.style.TextAppearance_AppCompat_Medium);
            widget.setWeekDayTextAppearance(com.prolificinteractive.materialcalendarview.R.style.TextAppearance_AppCompat_Medium);
        } else {
            widget.setHeaderTextAppearance(com.prolificinteractive.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_Header);
            widget.setDateTextAppearance(com.prolificinteractive.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_Date);
            widget.setWeekDayTextAppearance(com.prolificinteractive.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_WeekDay);
        }
    ...
    void onMinClicked() {
        showDatePickerDialog(getActivity(), widget.getMinimumDate(),
    ...
    void onMaxClicked() {
        showDatePickerDialog(getActivity(), widget.getMaximumDate(),
                (view, year, monthOfYear, dayOfMonth) ->
                        widget.state().edit()
    ...
    void onTileSizeClicked() {
        final NumberPicker view = new NumberPicker(getActivity());
        view.setMinValue(24);
        view.setMaxValue(64);
    ...
    void onTileWidthHeightClicked() {
        ...
        final NumberPicker pickerWidth = new NumberPicker(getActivity());
        ...
        final NumberPicker pickerHeight = new NumberPicker(getActivity());
