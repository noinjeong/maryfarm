...
import com.numberONE.maryfarm.databinding.ActivityDynamicSettersBinding;
...
public class DynamicSettersActivity extends AppCompatActivity implements OnDateLongClickListener {
  ActivityDynamicSettersBinding binding;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    binding = ActivityDynamicSettersBinding.inflate(getLayoutInflater());
