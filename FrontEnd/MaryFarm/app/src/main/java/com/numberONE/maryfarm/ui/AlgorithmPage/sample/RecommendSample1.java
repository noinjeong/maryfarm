...
public class RecommendSample1 extends AppCompatActivity{
    private static final String TAG="RecommendSample1";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_recommend_example1);
