...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolder> {
    ...
    public ChatAdapter(String[] plantName, String[] createdAt, String[] harvestTime){
        ChatAdapter.plantName = plantName;
        ChatAdapter.createdAt = createdAt;
        ChatAdapter.harvestTime = harvestTime;
    }
    // 커스텀 리스너 인터페이스 정의
