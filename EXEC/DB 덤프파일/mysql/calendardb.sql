...
CREATE TABLE `calendar` (
  ...
  `division` bit(1) DEFAULT NULL,
  `memo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nutrients` bit(1) DEFAULT NULL,
  `plant_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `water` bit(1) DEFAULT NULL,
  PRIMARY KEY (`day`,`month`,`plant_id`,`year`)
...
-- Dump completed on 2023-02-16 16:22:59
