...
import com.numberONE.maryfarm.databinding.ActivityCalendarBinding;
...
public class CalendarActivity extends AppCompatActivity implements OnDateLongClickListener {
    ActivityCalendarBinding binding;

    private static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("EEE, d MMM yyyy");

    @BindView(R.id.calendarView) MaterialCalendarView widget;
    @BindView(R.id.animate_mode_transition)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        widget.setOnTitleClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                Toast.makeText(CalendarActivity.this, R.string.today, Toast.LENGTH_SHORT).show();
            }
        });
